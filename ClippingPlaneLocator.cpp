 ...
 * parameter PointCloudViewer - PointCloudViewer *
 */
ClippingPlaneLocator::ClippingPlaneLocator(Vrui::LocatorTool * locatorTool,
		PointCloudViewer* PointCloudViewer) :
	BaseLocator(locatorTool, PointCloudViewer), clippingPlane(0) {
	/* Find a clipping plane index for this locator: */
	ClippingPlane * clippingPlanes = PointCloudViewer->getClippingPlanes();
	for (int i=0; i<PointCloudViewer->getNumberOfClippingPlanes(); ++i)
